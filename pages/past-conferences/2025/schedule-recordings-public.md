...
show_meta           : false
title               : "2025 Grading Conference"
teaser              : ""
permalink           : "/past-conferences/2025-grading-conference/"
---
...
<tr>
  ...
  {%if slot.parallel %}
    {%for track in slot.parallel %}
     <td style="font-size: 1.05em">
        <b>{{track.title}}</b>  {%if track.recording and track.recording-permission != "False" %} (<a href="{{track.recording}}" target="_blank">Recording</a>){% endif %} {% if track.slides-static %} (<a href="{{track.slides-static}}" target="_blank">Slides</a>){% endif %}
        <ul class="accordion" data-accordion style="margin-left: 0px">
  ...
  <td colspan="4" style="text-align: center; font-size:1.1em" >
    ...
    {% if slot.recording and slot.keynote-title == false %}
